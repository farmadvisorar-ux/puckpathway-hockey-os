...
(function(window) {
  ...
  const BENCHMARK_GOALIES = [
    ...
    },
    {
      ...
      league: "MSHSL Class AA",
      category: "scholastic",
      draftStatus: "NCAA D1 Prospect (2025 Eligible)",
      age: 18,
      height: "6'2\"",
      weight: 185,
      catches: "L",
      stance: "Athletic High-Glove Butterfly",
      tier: "MSHSL State Champion Starter",
      gsax: "+16.8",
      svPct: ".928",
      gaa: "1.65",
      hdsvPct: ".862",
      ...
      reboundScore: 91,
      recoverySpeed: "0.23s",
      rvhSealEfficiency: "93%",
      notes: "Anchor of Minnetonka's Class AA state championship run. Dominant slot-seam visual tracking, elite five-hole stick posture, and explosive recovery on scrambles."
    },
    {
      id: "g_peck",
      name: "Stephen Peck",
      team: "Avon Old Farms Winged Beavers",
      league: "NEPSAC Founders League",
      category: "scholastic",
      draftStatus: "Michigan commit / 2024 NHL Pick",
      age: 19,
      height: "6'3\"",
      weight: 195,
      catches: "L",
      stance: "Controlled Pro-Style Hybrid",
      tier: "NEPSAC Elite 8 Champion Starter",
      gsax: "+19.2",
      svPct: ".924",
      gaa: "1.85",
      hdsvPct: ".870",
      ...
      recoverySpeed: "0.24s",
      rvhSealEfficiency: "95%",
      notes: "Backboned Avon Old Farms to back-to-back New England Prep championships. Tall 6'3\" frame with compact five-hole seal, outstanding puck tracking through traffic, and high-slot rebound placement."
    },
    {
      id: "g_slukynsky",
      name: "Hampton Slukynsky",
      team: "Fargo Force / Western Michigan",
      league: "USHL / NCAA Commit",
      category: "junior",
      draftStatus: "Los Angeles Kings (2023, 118th)",
      age: 19,
      height: "6'1\"",
      weight: 190,
      catches: "L",
      stance: "Methodical Positional Butterfly",
      tier: "USHL Goaltender of the Year / Clark Cup MVP",
      gsax: "+21.5",
      svPct: ".923",
      gaa: "1.86",
      hdsvPct: ".868",
      ...
      recoverySpeed: "0.22s",
      rvhSealEfficiency: "96%",
      notes: "Warroad High School legend (Frank Brimsek Award winner) turned Clark Cup champion. Unflappable calm, disciplined post-to-post pushes, and surgical low rebound control."
    },
    {
      id: "g_fowler",
      name: "Jacob Fowler",
      ...
      league: "NCAA Division I",
      category: "ncaa",
      draftStatus: "Montreal Canadiens (2023, 69th)",
      age: 20,
      height: "6'2\"",
      weight: 214,
      catches: "L",
      stance: "Power Positional Butterfly",
      tier: "NCAA All-American / Frozen Four Finalist",
      gsax: "+23.8",
      svPct: ".926",
      gaa: "2.14",
      hdsvPct: ".879",
      ...
      reboundScore: 96,
      recoverySpeed: "0.23s",
      rvhSealEfficiency: "97%",
      notes: "USHL Goalie of the Year (Youngstown) and NCAA standout. Remarkable big-game composure, textbook squareness to puck, and elite blocker steering into corners."
    }
  ];
  ...
  const SHOOTOUT_SNIPERS = [
    ...
    { name: "Hagen Burrows", team: "Minnetonka Skippers (MSHSL)", rating: 93, dekeMove: "Quick Head-Fake Backhand Tuck", shotMove: "Catch-and-Release Top-Right Corner", releaseSpeed: "0.16s" },
    { name: "Joe Connor", team: "Avon Old Farms (NEPSAC)", rating: 91, dekeMove: "Inside Edge Stride Five-Hole Slide", shotMove: "Cross-Body Blocker-Side Snap", releaseSpeed: "0.17s" }
  ];
